...
const int YY_parse_CLASS::DT=261;
...
#define YYTRANSLATE(x) ((unsigned)(x) <= 261 ? yytranslate[x] : 11)
...
static const short yypact[] = {    -6,
    -3,    -5,    -2,    -3,    -6,-32768,-32768,     2,     4,-32768
};
